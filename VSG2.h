...
//	IsrVars.J=50,IsrVars.D=-90;
	...
	IsrVars.P0=1100,IsrVars.Qcmd=150,IsrVars.kq=0.00005;
...
#define start_pwm_time 0.22
#define stop_pwm_time 1.2
...
//			}
		...
		if(t <= start_pwm_time)
		{
			IsrVars.PLLtheta[4] = IsrVars.PLLtheta[3];
			IsrVars.PLLtheta[3] = IsrVars.PLLtheta[2];
			IsrVars.PLLtheta[2] = IsrVars.PLLtheta[1];
			IsrVars.PLLtheta[1] = IsrVars.PLLtheta[0];
			IsrVars.PLLtheta[0] = DsogiPLL.f32Theta+PI_2_VALUE/4;

			IsrVars.PLLtheta[5] = (IsrVars.PLLtheta[4]+IsrVars.PLLtheta[3]+IsrVars.PLLtheta[2]+IsrVars.PLLtheta[1]+IsrVars.PLLtheta[0])/5;		
			IsrVars.vsg_theta[1] = IsrVars.PLLtheta[5];
			if(IsrVars.vsg_theta[1] >= PI_2_VALUE)
			{
				IsrVars.vsg_theta[1] -= PI_2_VALUE;
			}
		}
...
//			}
			...
			IsrVars.f32Sin_Theta = __sin(IsrVars.vsg_theta[0]);
			IsrVars.f32Cos_Theta = __cos(IsrVars.vsg_theta[0]);
		
//			IsrVars.E[0]=IsrVars.T/IsrVars.kq*IsrVars.Qcmd-IsrVars.T/2/IsrVars.kq*(IsrVars.Qins[0]+IsrVars.Qins[1])+IsrVars.E[1];
//			IsrVars.E = IsrVars.kq*(IsrVars.Qcmd-IsrVars.Qins) + 89.8;
			IsrVars.E = IsrVars.kq*(IsrVars.Qcmd-IsrVars.Qave[0]) + 89.8;
			IsrVars.E = __fsat(IsrVars.E,91,89);
			
			IsrVars.Pcmd = IsrVars.P0-IsrVars.m*(IsrVars.omega[0]-377);
...
//			IsrVars.vbetacmd = VSG_Volt.f32Beta-0.09425*VarAC_Curr.f32Alpha;
			...
			if(IsrVars.theta_power>3 || IsrVars.theta_power<-3)
			{
